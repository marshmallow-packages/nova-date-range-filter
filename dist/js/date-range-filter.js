...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_DateRangeFilter__ = __webpack_require__(3);
...
var update = __webpack_require__(6)("56e7a736", content, false, {});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    ...
    startDate: function startDate() {
      return __WEBPACK_IMPORTED_MODULE_0_flatpickr___default.a.formatDate(__WEBPACK_IMPORTED_MODULE_0_flatpickr___default.a.parseDate(this.filter.currentValue[0], this.dateFormat), this.dateFormat);
    },
    endDate: function endDate() {
      return __WEBPACK_IMPORTED_MODULE_0_flatpickr___default.a.formatDate(__WEBPACK_IMPORTED_MODULE_0_flatpickr___default.a.parseDate(this.filter.currentValue[1], this.dateFormat), this.dateFormat);
    },
    ...
    handleChange: function handleChange(value) {
      ...
      setTimeout(function () {
        value = value.map(function (value) {
          return __WEBPACK_IMPORTED_MODULE_0_flatpickr___default.a.formatDate(value, _this2.dateFormat);
        });
        ...
        if (Object.keys(value).length === 0) {
          ...
          _this2.$store.dispatch(_this2.resourceName + '/resetFilterState', {
            filterClass: _this2.filterKey,
            value: value
          });
        }
